    ...
    ListBox.prototype = {
        ...
        filter: function(str) {
            ...
            if (foundItems === 0) {
                ...
                for (let index = 0; index < foundItems; index++) {
                    this.visibleItems[index].setAttribute('aria-posinset', index + 1);
                    this.visibleItems[posInSet].setAttribute('aria-setsize', foundItems);
                }
            }
        },
